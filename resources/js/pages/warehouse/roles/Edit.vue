...
const initialPermissionIds =
    props.permission_ids && props.permission_ids.length
        ...
        <div class="p-4 md:p-6">
            <Card>
                <CardHeader>
                    <CardTitle
                        >{{ t('common.edit') }} -
                        {{ formatRoleName(role.name) }}</CardTitle
                    >
                </CardHeader>
                <CardContent>
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                <div
                                    ...
                                    :key="group"
                                    class="rounded-lg border bg-slate-50/50 p-4 dark:bg-slate-900/50"
                                >
                                    <h3
                                        class="mb-3 border-b pb-2 font-bold text-primary capitalize"
                                    >
                                        {{ group.replace('_', ' ') }}
                                    </h3>
                                    <div class="space-y-3">
