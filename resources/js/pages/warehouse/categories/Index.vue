...
const breadcrumbs: BreadcrumbItem[] = [
    { title: t('nav.categories'), href: index.url() },
];

function destroy(id: number) {
    if (confirm(t('common.delete') + '?'))
        router.delete(`/warehouse/categories/${id}`);
}
</script>
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        <DropdownMenuItem
                                            ...
                                            as-child
                                            ><Link
                                                :href="`/warehouse/categories/${(c as any).id}/edit`"
                                                ><Pencil
                                                    class="mr-2 h-4 w-4"
                                                />{{ t('common.edit') }}</Link
                                            ></DropdownMenuItem
