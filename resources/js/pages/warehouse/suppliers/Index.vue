...
import {
    create,
} from '@/actions/App/Http/Controllers/Warehouse/SupplierController';
import { index } from '@/routes/warehouse/suppliers';
...
const breadcrumbs: BreadcrumbItem[] = [
    { title: t('nav.suppliers'), href: index.url() },
];
function destroy(id: number) {
    if (confirm(t('common.delete') + '?'))
        router.delete(`/warehouse/suppliers/${id}`);
}
</script>
        ...
        <AppPageContent>
            <template #header>
                ...
                >
                    ...
                    <Link v-if="can('suppliers.create')" :href="create.url()"
                        ><Button
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        <DropdownMenuItem
                                            ...
                                            as-child
                                            ><Link
                                                :href="`/warehouse/suppliers/${(s as any).id}/edit`"
                                                ><Pencil
                                                    class="mr-2 h-4 w-4"
                                                />{{ t('common.edit') }}</Link
                                            ></DropdownMenuItem
