...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div
            class="mx-auto flex h-full w-full max-w-7xl flex-1 flex-col gap-4 p-4 md:p-6"
        >
            ...
            <div class="grid gap-4 lg:grid-cols-3">
                <Card class="lg:col-span-2" :class="glassCardClass">
                    <CardHeader>
                        <div
                ...
                <Card :class="glassCardClass">
                    ...
                    <CardContent>
                        <div class="space-y-3">
                            ...
                            <div
                                class="rounded-md border p-2 text-xs text-muted-foreground"
                            >
                                {{ t('accounting.walletInput') }}:
                                {{
            ...
            >
                <p class="text-sm text-muted-foreground">
                    ...
                    {{ $t('common.to') }} {{ entries.to }} {{ $t('common.of') }}
                    {{ entries.total }}
                </p>
