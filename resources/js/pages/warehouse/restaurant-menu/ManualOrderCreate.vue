            ...
            <template #header>
                <div class="p-4 pb-0 md:p-6 md:pb-0">
                    ...
                    <p class="text-sm text-muted-foreground">
                        {{ t('restaurantMenu.manualOrderHelp') }}
                    </p>
                </div>
            </template>
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-5">
                            <div class="space-y-2">
                                ...
                                >
                                    {{ form.errors.restaurant_table_id }}
                                </p>
                            </div>
                    ...
                    <aside class="space-y-4 xl:sticky xl:top-4 xl:self-start">
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <div
                                    class="mt-3 border-t pt-3 text-lg font-bold"
                                >
                                    {{ t('common.total') }}:
                                    {{ total.toFixed(2) }}
                                </div>
                                ...
                                <div class="mt-3 flex gap-2">
                                    <Button
                                        ...
                                        >{{
                                            t(
                                                'restaurantMenu.submitManualOrder',
                                            )
                                        }}</Button
                                    >
                                    <Link
                                        href="/warehouse/restaurant-orders"
                                        class="flex-1"
                                        ><Button
                                            variant="outline"
                                            class="w-full"
