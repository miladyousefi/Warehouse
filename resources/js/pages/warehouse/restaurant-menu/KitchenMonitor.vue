...
const localeField = computed(() =>
    locale.value === 'tr' ? 'name_tr' : 'name_en',
);
...
const canEditOrders = computed(
    () =>
        can('restaurant_orders.edit') ||
        can('restaurant_orders.monitor.confirm_cancel'),
);
...
function submitCancel(): void {
    ...
    statusForm.patch(
        `/warehouse/restaurant-orders/${cancelTargetOrder.value.id}/status`,
        {
            preserveScroll: true,
            onSuccess: () => {
                closeCancelModal();
...
<template>
    ...
    <div class="min-h-screen bg-background text-foreground">
        <div class="mx-auto max-w-7xl p-4 md:p-6">
            <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Only confirm or cancel incoming orders.
                    </p>
                </div>
                        ...
                        >
                            ...
                            <div class="mt-3 flex items-center gap-2">
                                ...
                                <Button
                                    ...
                                    class="flex-1"
                                    :disabled="
                                        !canEditOrders || statusForm.processing
                                    "
            ...
            >
                <div
                    class="w-full max-w-4xl rounded-lg border bg-background p-4 shadow-xl"
                >
                        ...
                        <CardContent>
                            <Table class="rounded-md border">
                                ...
                                <TableBody>
                                    ...
                                    >
                                        <TableCell>{{
                                            item.menu_item?.[localeField] ||
                                            item.menu_item?.name_tr ||
                                            '-'
                                        }}</TableCell>
                    ...
                    <div
                        v-if="selectedOrder.customer_note"
            ...
            <div
                ...
                class="fixed inset-0 z-[130] flex items-center justify-center bg-black/35 p-4"
            >
                <div
                    class="w-full max-w-md rounded-lg border bg-background p-4 shadow-xl"
                >
                    <h3 class="text-base font-semibold">Cancel Order</h3>
                    <p class="mt-1 text-sm text-muted-foreground">
                        {{ cancelTargetOrder.order_code }} -
                        {{
                            cancelTargetOrder.table?.name ||
                            cancelTargetOrder.table?.table_number ||
                            '-'
                        }}
                    </p>
