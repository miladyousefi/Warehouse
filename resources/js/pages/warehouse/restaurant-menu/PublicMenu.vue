...
<template>
  ...
  <div class="min-h-screen transition-colors duration-300" :class="theme.page">
    <div class="mx-auto max-w-7xl px-4 py-8 md:px-6">
      <section class="menu-fade mb-5 rounded-3xl border p-6 shadow-sm md:p-8" :class="theme.hero">
        ...
        <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            <h1 class="text-4xl font-black tracking-tight" :class="template === 'template_4' ? 'font-serif' : 'font-sans'">{{ t('restaurantMenu.title') }}</h1>
      ...
      <section class="menu-fade sticky top-2 z-20 mb-5 rounded-2xl border p-3 shadow-sm backdrop-blur" :class="theme.hero">
              ...
              <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                <article v-for="item in cat.items" :key="item.id" class="menu-card overflow-hidden rounded-2xl border shadow-sm" :class="theme.card">
                  <div class="relative aspect-[4/3] overflow-hidden">
                    <img v-if="item.image_url" :src="item.image_url" alt="food" class="h-full w-full object-cover transition duration-300 group-hover:scale-105" />
