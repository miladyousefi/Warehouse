...
const props = defineProps<{
    setting: { layout_type: string; is_public: boolean };
    categories: Array<Record<string, any>>;
}>();
const breadcrumbs: BreadcrumbItem[] = [
    {
        title: t('restaurantMenu.menuView'),
        href: '/warehouse/restaurant-menu/show',
    },
];
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-5 p-4 md:p-6">
            <section
                class="menu-fade rounded-3xl border p-6 shadow-sm"
                :class="theme.hero"
            >
                <div
            ...
            <section
                class="menu-fade sticky top-2 z-20 rounded-2xl border p-3 shadow-sm backdrop-blur"
                :class="theme.hero"
            >
                <div
