...
const breadcrumbs: BreadcrumbItem[] = [
    { title: t('nav.admins'), href: index.url() },
];
                ...
                <Table class="bg-transparent">
                    <TableHeader>
                        <TableRow class="border-b border-border">
                            ...
                            <TableHead class="w-24 text-muted-foreground">{{
                                t('common.actions')
                            }}</TableHead>
                        </TableRow>
                    </TableHeader>
                        ...
                        >
                            ...
                            <TableCell>
                                <div class="flex flex-wrap gap-1">
                                    <Badge
                                        v-for="r in (u as any).roles || []"
                                        :key="(r as any).id"
                                        variant="outline"
                                        class="border-primary/20 bg-primary/5 text-xs"
                                    >
                                        {{ formatRoleName((r as any).name) }}
                                    </Badge>
                                    <span
                                        v-if="!((u as any).roles || []).length"
                            ...
                            <TableCell class="whitespace-nowrap">{{
                                formatTurkeyDate((u as any).created_at)
                            }}</TableCell>
                            <TableCell>
