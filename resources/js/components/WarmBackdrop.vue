<template>
    <div class="warm-root">
        <div class="warm-blob warm-blob-1" />
        <div class="warm-blob warm-blob-2" />
        <div class="warm-blob warm-blob-3" />
        <div class="warm-grain" />
...
.warm-blob-2 {
    ...
    top: 30%;
    right: -220px;
    animation: warmFloat2 22s ease-in-out infinite;
}
...
.warm-blob-3 {
    ...
    bottom: -120px;
    left: 25%;
    animation: warmFloat3 16s ease-in-out infinite;
}
...
@keyframes warmFloat2 {
    ...
    50% {
        transform: translate(-60px, -45px) scale(1.06);
    }
}
@keyframes warmFloat3 {
    ...
    40% {
        transform: translate(30px, -60px) scale(1.04);
    }
    70% {
