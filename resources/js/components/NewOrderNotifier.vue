...
function openOrder(order: { order_code?: string; table?: { name?: string; table_number?: string } }): void {
...
<template>
    <div v-if="show && canSeeOrders" class="fixed inset-0 z-[120] flex items-center justify-center bg-black/35 p-4">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        {{ orderCode ? `Order: ${orderCode}` : 'A new order has arrived.' }}
                    </p>
