...
function setupListener(): void {
    ...
    w.Echo.private('restaurant-orders').listen(
        ...
        (payload: any) => {
            ...
            const wasCancelled =
                (payload?.previous_status || '') === 'cancelled';
...
<template>
    <div
        ...
        class="fixed inset-0 z-[121] flex items-center justify-center bg-black/35 p-4"
    >
        <div
        ...
        >
            <div class="flex items-start gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <p v-if="reason" class="mt-1 text-xs text-muted-foreground">
                        Reason: {{ reason }}
                    </p>
                </div>
            </div>
